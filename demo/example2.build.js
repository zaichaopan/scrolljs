...
var cb = function cb() {
    alert("You have reach the container bottom");
};

var container = document.querySelector('.container');

_index2.default.reachToBottom(container, cb);
...
exports.default = {
    ...
    scrollToward: function scrollToward(upCb, downCb) {
        ...
        if (el === null) {
            window.onscroll = function (e) {
                window.scrollY > scrollTop ? downCb.apply(undefined, _arguments) : upCb.apply(undefined, _arguments);
                scrollTop = window.scrollY;
            };
        } else {
            el.onscroll = function (e) {
                el.scrollTop > scrollTop ? downCb.apply(undefined, _arguments) : upCb.apply(undefined, _arguments);
